...
public sealed class JwtTokenService
{
    ...
    public AuthenticatedPrincipal? ValidateToken(string token)
    {
        ...
        return new AuthenticatedPrincipal(payload.Subject, scopes, payload.IssuedAt);
    }
...
public sealed record AuthenticatedPrincipal(string Subject, IReadOnlySet<string> Scopes, long IssuedAtUnixTimeSeconds)
{
